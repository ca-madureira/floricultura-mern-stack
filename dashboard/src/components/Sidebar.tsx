...
export const Sidebar = () => {
  return (
    <div className="flex justify-between w-full">
      <aside className="bg-pink-500 w-[12%] md:w-[20%] h-screen sticky top-0 left-0">
        ...
        <hr className="w-full border-b-1 border-pink-200" />
        <nav className="text-center text-white">
          <ul>
            <li className="flex items-center gap-2 m-2 p-2 hover:bg-pink-300 hover:text-pink-600 font-medium hover:rounded-md cursor-pointer">
